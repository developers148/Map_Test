...
public class showDestination extends AppCompatActivity implements PermissionsListener {
    ...
    private Point destinationPoint,finalpoint;
                    ...
                    public void onStyleLoaded(@NonNull Style style) {
                        ...
                        databaseReference.addChildEventListener(new ChildEventListener() {
                            ...
                            public void onChildRemoved(@NonNull DataSnapshot dataSnapshot) {
                                Toast.makeText(showDestination.this, "child removed"+dataSnapshot.getValue().toString(), Toast.LENGTH_SHORT).show();
...
// Add the red marker icon SymbolLayer to the map
    ...
    private void newinitLayers(@NonNull Style loadedMapStyle) {
...
// Add the LineLayer to the map. This layer will display the directions route.
        ...
        Bitmap bitmap = BitmapUtils.getBitmapFromDrawable(getResources().getDrawable(R.drawable.red_marker));
// Add the red marker icon image to the map
        loadedMapStyle.removeImage(RED_PIN_ICON_ID);
// Add the red marker icon SymbolLayer to the map
        SymbolLayer symbolLayer = new SymbolLayer(ICON_LAYER_ID,ICON_SOURCE_ID).withProperties(iconImage(RED_PIN_ICON_ID),iconIgnorePlacement(true),iconAllowOverlap(true),iconOffset(new Float[]{0f, -9f}));
        loadedMapStyle.removeLayer(symbolLayer);
...
// reset the GeoJSON source for the route LineLayer source
    ...
    private void enableLocationComponent(@NonNull Style loadedMapStyle) {
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            ...
            LocationComponent locationComponent = mapbo.getLocationComponent();
    ...
    public void onPermissionResult(boolean granted) {
        if (granted) {
            mapbo.getStyle(new Style.OnStyleLoaded() {
                @Override
                public void onStyleLoaded(@NonNull Style style) {
                    enableLocationComponent(style);
                }
    ...
    private static class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<showDestination> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(showDestination activity) {
        ...
        public void onSuccess(LocationEngineResult result) {
            showDestination activity = activityWeakReference.get();
            ...
            if (activity != null) {
                ...
                if (activity.mapbo != null && result.getLastLocation() != null) {
                    activity.mapbo.getLocationComponent().forceLocationUpdate(result.getLastLocation());
                }
            }
        }
