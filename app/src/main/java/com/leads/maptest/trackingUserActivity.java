...
public class trackingUserActivity extends AppCompatActivity implements
...
databaseReference = FirebaseDatabase.getInstance().getReference();
    ...
    private static class LocationChangeListeningActivityLocationCallback
        ...
        private final WeakReference<trackingUserActivity> activityWeakReference;

        LocationChangeListeningActivityLocationCallback(trackingUserActivity activity) {
